...
public class BeerController {
    ...
    @PostMapping
    public ResponseEntity saveNewBeer(@RequestBody @NotNull @Valid BeerDto beerDto) {
        //todo impl
        return new ResponseEntity(HttpStatus.CREATED);
    }

    @PutMapping("/{beerId}")
    public ResponseEntity updateBeerById(@NotNull @PathVariable("beerId") UUID beerId, @RequestBody @NotNull @Valid BeerDto beerDto) {
        //todo impl
